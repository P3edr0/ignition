...
Future updateUserDialog(BuildContext context, int id, String name, String email,
    String tags, String token) async {
  HomeController homeController = HomeController();
  TextEditingController nameController = TextEditingController(text: name);
  TextEditingController emailController = TextEditingController(text: email);
  TextEditingController tagsController = TextEditingController(text: tags);
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    Map result = await homeController.updateUser(
                        id,
                        nameController.text,
